                        ...
                        <div className="col-md-10 col-lg-9">
                            <div className="section-sub-title center">
                                <article className="section-title-body">
                                        ...
                                        <Link to='portfolio' className="btn-default  btn-move" smooth={false} duration={800}>Work Experience</Link>&nbsp;
                                        <Link to='footer' className="btn-default active btn-move t1" smooth={false} duration={800}>Contact</Link>
                                </article>
                            </div>   
                        </div>
                    </div>
